        ...
        if num_frames < 30:
            ...
            if hand is not None:
                ...
                if value >= 0.99:
                    ...
                    cv2.putText(clone, 'Gesture Recognized as: '+str(result), (10, 25),  cv2.FONT_HERSHEY_SIMPLEX,0.5, (0, 255, 255), 2)
                    if oldresult != result:
...
font = ('times', 20, 'bold')
title = Label(main, text='Hand Gesture Recognition and Voice Conversion using CNN',anchor=W, justify=CENTER)
